...
#define THROW01 "Create: привышен размер имени словар€"
#define THROW02 "Create: привышен размер максимальной Ємкости словар€"
#define THROW03 "AddEntry: —ловарь переполнен"
#define THROW04 "AddEntry: ƒублированеие идентификатора"
...
#define THROW08 "UpdEntry: ƒублированеие идентификатора"

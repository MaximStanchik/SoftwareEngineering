#include"Dictionary.h" //это директива. пишем # потом ключевое слово которое означает что это за директива и что делает директива
#include"index.h"
using namespace std;
...
#error "¬ызываетьс€ слишком много проверок"
#endif

int main() {
	setlocale(LC_ALL, "ru");
	try { //try--дл€ обработки исключений
#ifdef TEST01 //длина названи€
...
#ifdef TEST09 //ввод нормальных данных в словарь и показ данных словар€
